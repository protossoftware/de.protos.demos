...
C_SRCS += \
../etRuntime/src/common/debugging/etDataLogger.c \
../etRuntime/src/common/debugging/etMSCLogger.c 

OBJS += \
./etRuntime/src/common/debugging/etDataLogger.o \
./etRuntime/src/common/debugging/etMSCLogger.o 

C_DEPS += \
./etRuntime/src/common/debugging/etDataLogger.d \
./etRuntime/src/common/debugging/etMSCLogger.d 


# Each subdirectory must supply rules for building sources it contributes
etRuntime/src/common/debugging/%.o: ../etRuntime/src/common/debugging/%.c
	@echo 'Building file: $<'
