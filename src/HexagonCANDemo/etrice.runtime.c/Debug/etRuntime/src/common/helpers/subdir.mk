...
C_SRCS += \
../etRuntime/src/common/helpers/etTimeHelpers.c 

OBJS += \
./etRuntime/src/common/helpers/etTimeHelpers.o 

C_DEPS += \
./etRuntime/src/common/helpers/etTimeHelpers.d 


# Each subdirectory must supply rules for building sources it contributes
etRuntime/src/common/helpers/%.o: ../etRuntime/src/common/helpers/%.c
	@echo 'Building file: $<'
