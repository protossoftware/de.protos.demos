...
typedef osMutexId etOSMutexData;
typedef osSemaphoreId etOSSemaData;
typedef osThreadId etOSThreadData;
typedef osTimerId etOSTimerData;

typedef etUInt32 etOSThreadId;
//typedef osTimerId etOSTimerId;
#endif /* _DATATYPES_H_ */
